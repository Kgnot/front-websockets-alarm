...
export class AlarmSection implements OnInit, OnDestroy {
  ...
  deleteNotification(notification: AlarmData) {
    ...
    //this.webSocketService.deleteAlarm(notification.id);
    //his.webSocketService.quitar pintura () | aunque no es su responsabilidad, toca ver como xd, quiza injectamos pero no tendria setnido
  }
